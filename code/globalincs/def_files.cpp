...
"uniform vec3 base_color_g;\n"
"uniform vec3 stripe_color_g;\n"
...
"	vec3 base_g = base_color_g - vec3(0.5);\n"
"	vec3 stripe_g = stripe_color_g - vec3(0.5);\n"
"	glowColor = mix((base_g * teamMask.b) + (stripe_g * teamMask.a), glowColor, clamp(glowColorLuminance - teamMask.b - teamMask.a, 0.0, 1.0));\n"
"  #endif\n"
" #endif\n"
